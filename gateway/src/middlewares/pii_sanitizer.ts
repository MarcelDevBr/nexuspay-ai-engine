...
// Regex para detecção de cartões de crédito (13 a 19 dígitos)
const CREDIT_CARD_REGEX = /\b(?:\d[ -]*?){13,19}\b/g;

// Regex para detecção de CPF (formatado ou apenas números com 11 dígitos)
const CPF_REGEX = /\b\d{3}\.?\d{3}\.?\d{3}-?\d{2}\b/g;

// Regex para detecção de CVV (3 ou 4 dígitos isolados ou com etiqueta)
